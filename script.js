(() => {
  ...
  const copy = {
    en: {
      ...
      hobbies: 'Beyond research', hobbiesTitle: 'Things I enjoy away from the screen.', basketball: 'Basketball', basketballNote: 'Long-time NBA fan · Always happy to talk basketball', billiards: 'Billiards', piano: 'Piano', bridge: 'Bridge',
    ...
    zh: {
      ...
      hobbies: '个人爱好', hobbiesTitle: '研究之外，也认真享受生活。', basketball: '篮球', basketballNote: 'NBA 资深球迷 · 欢迎一起聊球', billiards: '台球', piano: '钢琴', bridge: '桥牌',
